...
import org.higherstate.jameson.exceptions.{UnexpectedKeyException, KeyNotFoundException}
import collection.mutable
import org.higherstate.jameson.{Selector, Registry, Path}

case class CloseMapParser(selectors:Map[String, Selector[String,_]]) extends KeyValuePairsExtractor[Map[String, Any]] {

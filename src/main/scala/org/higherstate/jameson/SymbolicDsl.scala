...
object SymbolicDsl {
  ...
  def AsDateTime(implicit dateTimeFormatter:Option[DateTimeFormatter], dateTimeZone:ZoneOffset):DateTimeParser = DateTimeParser()(dateTimeFormatter, dateTimeZone)
